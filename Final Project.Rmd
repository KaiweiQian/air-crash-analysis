...
```{r get.air.crash.data, results='hide'}
...
```{r get.air.crash.detail, results='hide'}
tbl_air_accident_raw <- read_csv("./Intermediate Results/air_accident_table_2014-2019.csv")
...
# save this dataframe to csv.file
write_csv(tbl_air_accident_raw, path = "./Intermediate Results/air_accident_table_with_detail_2014-2019.csv")
rm(list=ls()); gc()
```
